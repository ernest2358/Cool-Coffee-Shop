...
namespace Cool_Coffee_Shop
{
    public class Product
    {
        ...
        //Is the list on correct page or should the list be displayed in the order class

        //Should each object(new product) be acded like a new ctor or should they be all new objects maybe placed in like a Food(set up like group of food) or Drinks(set up like new ctor) 
